...
### phoneme_example
# This script demonstrates how to use the Kokoro TTS pipeline to generate audio from phonemes.
# It includes examples of generating audio from raw phonemes and pre-processed tokens.
...
def main():
    ...
    try:
        ...
        for result in pipeline.generate_from_tokens(
            ...
            save_audio(result.audio, f'token_output_{hash(result.phonemes)}.mp3')
